...
process.MessageLogger = cms.Service(
    "MessageLogger",
    destinations = cms.untracked.vstring('readFromFile_135454'),
    readFromFile_135454 = cms.untracked.PSet(threshold = cms.untracked.string('DEBUG')),
...
process.siStripDQMHistoryPopCon = cms.EDAnalyzer(
    ...
    Source = cms.PSet(
        since = cms.untracked.uint32(135454),
...
process.RPCHistoryDQMService = cms.Service(
    ...
    RunNb = cms.uint32(135454),
    accessDQMFile = cms.bool(True),
    FILE_NAME = cms.untracked.string(
          "/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/data/OfflineData/Commissioning10/MinimumBias/00013xxxx/DQM_V0001_R000135454__MinimumBias__Commissioning10-PromptReco-v9__RECO.root"
    ),
    ME_DIR = cms.untracked.string("Run 135454/RPC/"),
    histoList = cms.VPSet(
